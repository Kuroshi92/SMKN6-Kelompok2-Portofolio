  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 min-w-max ">
        ...
        <div className="relative z-10 w-[590px] bg-slate-900 sm:py-[24px] mt-[0.6px] bg-opacity-50">
          <img
        ...
        <div className="relative z-10 flex flex-col w-[40%] py-12 bg-slate-900 bg-opacity-50 sm:py-[71px]">
          <h1 className="text-3xl font-bold -mt-14 text-white">
