...
import "../index.css";
import "../App.css";
import School from "../asset/truebeauty.webp";
import { useState } from "react";
import React from "react";
import { dataschool } from "../commponents/datatruebeauty";
import Footer from "../commponents/footer";

const Truebeautypage = () => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 min-w-max ">
        ...
        <div className="relative z-10 w-[590px] bg-slate-900 sm:py-[6px] mt-[0.6px] bg-opacity-50">
          <img
            className="mx-auto ml-28 rounded-lg shadow-lg sm:max-w-md w-56"
            src={
              "https://th.bing.com/th/id/OIP.AOwLA-_Ah5T6MIjqPoRhqAHaKf?pid=ImgDet&rs=1"
            }
            alt="Movie Poster"
          />
        </div>
        ...
        <div className="relative z-10 flex flex-col w-[40%] py-20 bg-slate-900 bg-opacity-50 sm:py-[33px]">
          ...
          <div className="flex items-center text-white text-lg font-semibold mb-1">
            ...
            <span className="text-blue-200">Monster Union</span>
          </div>
          <div className="flex items-center text-white text-lg font-semibold mb-1">
            <span className="mr-2">Sutradra:</span>
            <span className="text-blue-200"> Kim Sang-hyub.</span>
          </div>
          <div className="pt-9">
            <button
              type="button"
            ...
            >
              ...
              <a href="https://youtu.be/GqnQs5ybyq8" target="_blank">Tonton Cuplikan</a>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-800 text-white">
        ...
        <div className="px-3 font-sans font-thin ">
          ...
          >
            <br />
            "True Beauty" adalah webtoon populer asal Korea Selatan yang ditulis oleh Yaongyi dan diadaptasi menjadi serial drama televisi. Cerita ini berpusat pada seorang siswi SMA bernama Lim Ju-kyung, yang memiliki kemampuan makeup yang luar biasa. 
            Namun, dia mengalami rendahnya rasa percaya diri karena penampilannya yang dirasa kurang menarik dan sering menjadi korban bully oleh teman-temannya.
            <br />
            Hidup Ju-kyung berubah ketika dia pindah ke sekolah baru dan memutuskan untuk menyembunyikan kemampuan makeup-nya. 
            Dia bertemu dengan Lee Su-ho, seorang cowok tampan dan populer yang juga memiliki luka emosionalnya sendiri. Su-ho menemukan kecantikan alami Ju-kyung tanpa makeup dan menjadi tertarik padanya.
            <br />
            Seiring berjalannya cerita, Ju-kyung menjadi terbelah antara menjaga penampilan aslinya atau terus mengandalkan makeup untuk meningkatkan rasa percaya dirinya. 
            Dia terjebak dalam segitiga cinta dengan Su-ho dan teman sekelas lainnya bernama Han Seo-jun, yang merupakan sosok yang ramah dan peduli. Keduanya jatuh cinta pada Ju-kyung, yang menyebabkan emosi dan konflik yang kompleks.
            <br />
            Selama perkembangan cerita, "True Beauty" juga mengangkat berbagai tema seperti pertemanan, penerimaan diri, dan mengeksplorasi definisi kecantikan yang sebenarnya. 
            Cerita ini menggambarkan perjuangan Ju-kyung dalam mencari identitasnya sendiri dan belajar menerima dirinya apa adanya.
          </p>
          <button
