    ...
    return(
        <div>
            ...
            <div className="text-center py-7 px-7">
                ...
                <button type="button" class="text-white bg-[#1da1f2] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 dark:hover:bg-[#1da1f2]/30 mr-2 mb-2">
                ...
                <button type="button" class="text-white bg-[#f41616] hover:bg-[#f41616] focus:ring-4 focus:outline-none focus:ring-[#f41616]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#f41616]/30 mr-2 mb-2">
                ...
                <h1><span>Terms Of Service · Privacy Policy</span></h1>
                <h1><span>Copyright ©2023 - All rights reserved.</span></h1>
                </div>
            </footer>
        </div>
    )
